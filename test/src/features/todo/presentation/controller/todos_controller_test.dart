...
void main() {
  ...
  test('initial state is Loading And Then Loads Data', () async {
  ...
  test('getTodoById returns the correct todo item', () async {
    ...
    todosController.state.whenData(
      (value) {
  ...
  test('updateTodo updates an existing todo item in the state', () {
    final todosController = container.read(todosControllerProvider.notifier);
    const updatedTodo =
    ...
    todosController.state.whenData(
      (value) async {
        ...
        final updatedState =
            todosController.state.value!.firstWhere((todo) => todo.id == '2');
  ...
  test(
    ...
    todosController.state.whenData(
      (value) async {
        ...
        final remainingTodos = todosController.state.value!;
    ...
    todosController.state.whenData(
      (value) async {
        await todosController
            .deleteTodosSelection([todoToDelete1, todoToDelete2]);
  ...
  test('reorderNote reorders todo items in the state', () {
    final todosController = container.read(todosControllerProvider.notifier);
